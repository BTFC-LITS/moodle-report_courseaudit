...
$export = $DB->get_recordset_sql("SELECT cr.id, ca.name AS 'category',
        ...
        cr.enrolnum AS 'applicants', cr.activenum AS 'active',
        ...
        WHERE ca.name LIKE 'taster courses'
...
header('Content-Disposition: attachment; filename="taster_audit_' . date(Ymd) . '.xls"');
